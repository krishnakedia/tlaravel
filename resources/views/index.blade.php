...
@section('main-section')
                        ...
                        <div class="row">
                            <div class="col-lg-12 align-self-center">
                                <div class="slide-item-info">
                                    <div class="slide-item-info-inner ltn__slide-animation">
                                        ...
                                        <h6 class="slide-sub-title animated"><img
                                                src="{{ url('/') }}/user_asset/img/icons/icon-img/1.png"
                                ...
                                <div class="slide-item-img">
                                    <img src="{{ url('/') }}/user_asset/img/slider/23.png" alt="#">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 align-self-center">
                                ...
                                <div class="slide-item-img slide-img-left">
                                    <img src="{{ url('/') }}/user_asset/img/slider/21.png" alt="#">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row ltn__custom-gutter--- justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="ltn__banner-item">
                        <div class="ltn__banner-img">
                            <a href="shop.html"><img src="{{ url('/') }}/user_asset/img/banner/1.jpg"
                                    alt="Banner Image"></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="ltn__banner-item">
                        <div class="ltn__banner-img">
                            <a href="shop.html"><img src="{{ url('/') }}/user_asset/img/banner/2.jpg"
                                    alt="Banner Image"></a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row ltn__custom-gutter--- justify-content-center">
                <div class="col-lg-6 col-md-6">
                    <div class="ltn__banner-item">
                        <div class="ltn__banner-img">
                            <a href="shop.html"><img src="{{ url('/') }}/user_asset/img/banner/13.png"
                                    alt="Banner Image"></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="ltn__banner-item">
                                <div class="ltn__banner-img">
                                    <a href="shop.html"><img src="{{ url('/') }}/user_asset/img/banner/14.png"
                                            alt="Banner Image"></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="ltn__banner-item">
                                <div class="ltn__banner-img">
                                    <a href="shop.html"><img src="{{ url('/') }}/user_asset/img/banner/15.png"
                                            alt="Banner Image"></a>
                                </div>
                            </div>
                        </div>
    ...
    <div class="ltn__blog-area pt-115 pb-70">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title-area ltn__section-title-2 text-center">
                        <h1 class="section-title white-color---">Our Categories</h1>
                    </div>
                </div>
            </div>
            <div class="row  ltn__blog-slider-one-active slick-arrow-1 ltn__blog-item-3-normal">
                <!-- Blog Item -->
                <div class="col-lg-12">
                    <div class="ltn__blog-item ltn__blog-item-3 xyz">
                        <div class="ltn__blog-img">
                            <a href="potato.php"><img src="{{ url('/') }}/user_asset/img/apple.webp" width="100%"
                                    alt="#"></a>
                        </div>
                        <div class="ltn__blog-brief">
                            ...
                            <h3 class="ltn__blog-title"><a href="potato.php">Fresh Fruits</a></h3>
                            <div class="ltn__blog-meta-btn">

                                <div class="ltn__blog-btn">
                                    <a href="potato.php">Read more</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="ltn__blog-item ltn__blog-item-3 xyz">
                        <div class="ltn__blog-img">
                            <a href="potato.php"><img src="{{ url('/') }}/user_asset/img/herbs.webp"
                                    alt="#"></a>
                        </div>
                        <div class="ltn__blog-brief">
                            <!-- <div class="ltn__blog-meta">
                            ...
                            <h3 class="ltn__blog-title"><a href="potato.php">Herbs & Seasonings</a></h3>
                            <div class="ltn__blog-meta-btn">
                                <!-- <div class="ltn__blog-meta">
                                      <ul>
                ...
                <div class="col-lg-12">
                    <div class="ltn__blog-item ltn__blog-item-3 xyz">
                        <div class="ltn__blog-img">
                            <a href="potato.php"><img src="{{ url('/') }}/user_asset/img/brocoli.webp"
                                    alt="#"></a>
                        </div>
                        <div class="ltn__blog-brief">
                            <div class="ltn__blog-meta">
                            ...
                            <h3 class="ltn__blog-title"><a href="potato.php">Organic Fruits & Vegetables</a></h3>
                            <div class="ltn__blog-meta-btn">
                                <!-- <div class="ltn__blog-meta">
                                      <ul>
                ...
                <div class="col-lg-12">
                    <div class="ltn__blog-item ltn__blog-item-3 xyz">
                        <div class="ltn__blog-img">
                            <a href="#"><img src="{{ url('/') }}/user_asset/img/1.png" alt="#"></a>
                        </div>
                        <div class="ltn__blog-brief">
                            <div class="ltn__blog-meta">
                                <ul>
                            ...
                            <h3 class="ltn__blog-title"><a href="#">Exotic Fruits & Veggies</a></h3>
                            <div class="ltn__blog-meta-btn">
                                <!-- <div class="ltn__blog-meta">
                                      <ul>
                                          <li class="ltn__blog-date"><i class="far fa-calendar-alt"></i>June 24, 2020</li>
                ...
                <div class="col-lg-12">
                    <div class="ltn__blog-item ltn__blog-item-3 xyz">
                        <div class="ltn__blog-img">
                            <a href="potato.php"><img src="{{ url('/') }}/user_asset/img/flower.webp"
                                    alt="#"></a>
                        </div>
                        <div class="ltn__blog-brief">
                            <div class="ltn__blog-meta">
                            ...
                            <h3 class="ltn__blog-title"><a href="potato.php">Flower Bouquets, Bunches</a></h3>
                            <div class="ltn__blog-meta-btn">
                                <!-- <div class="ltn__blog-meta">
                                      <ul>
                                          <li class="ltn__blog-date"><i class="far fa-calendar-alt"></i>June 24, 2020</li>
                                ...
                                <div class="row ltn__tab-product-slider-one-active slick-arrow-1">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <a href="product-details.php"><img
                                                        src="{{ url('/') }}/user_asset/img/product/11.png"
                                                        alt="#"></a>
                                        ...
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <a href="product-details.php"><img
                                                        src="{{ url('/') }}/user_asset/img/product/7.png"
                                                        alt="#"></a>
                                                <div class="product-badge">
                                                    <ul>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <a href="product-details.php"><img
                                                        src="{{ url('/') }}/user_asset/img/product/12.png"
                                                        alt="#"></a>
                                                <div class="product-badge">
                                                    <ul>
                                                        <li class="sale-badge">-19%</li>
                                        ...
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <a href="#"><img
                                                        src="{{ url('/') }}/user_asset/img/product/8.png"
                                                        alt="#"></a>
                                                <div class="product-badge">
                                                    <ul>
                                                        <li class="sale-badge">New</li>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <a href="#"><img
                                                        src="{{ url('/') }}/user_asset/img/product/13.png"
                                                        alt="#"></a>
                                                <div class="product-badge">
                                                    <ul>
                                                        <li class="sale-badge">New</li>
                                        ...
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <a href="#"><img
                                                        src="{{ url('/') }}/user_asset/img/product/9.png"
                                                        alt="#"></a>
                                                <div class="product-badge">
                                                    <ul>
                                                        <li class="sale-badge">-19%</li>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <a href="#"><img
                                                        src="{{ url('/') }}/user_asset/img/product/14.png"
                                                        alt="#"></a>
                                                <div class="product-badge">
                                                    <ul>
                                                        <li class="sale-badge">New</li>
                                        ...
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <a href="#"><img
                                                        src="{{ url('/') }}/user_asset/img/product/10.png"
                                                        alt="#"></a>
                                                <div class="product-badge">
                                                    <ul>
                                                        <li class="sale-badge">New</li>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <a href="#"><img
                                                        src="{{ url('/') }}/user_asset/img/product/15.png"
                                                        alt="#"></a>
                                                <div class="product-badge">
                                                    <ul>
                                                        <li class="sale-badge">New</li>
                                        ...
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <a href="#"><img
                                                        src="{{ url('/') }}/user_asset/img/product/6.png"
                                                        alt="#"></a>
                                                <div class="product-badge">
                                                    <ul>
                                                        <li class="sale-badge">-19%</li>
                                ...
                                <div class="row ltn__tab-product-slider-one-active slick-arrow-1">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <a href="#"><img
                                                        src="{{ url('/') }}/user_asset/img/product/16.png"
                                                        alt="#"></a>
                                                <div class="product-badge">
                                                    <ul>
                                                        <li class="sale-badge">-19%</li>
                                ...
                                <div class="row ltn__tab-product-slider-one-active slick-arrow-1">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <a href="#"><img
                                                        src="{{ url('/') }}/user_asset/img/product/3.png"
                                                        alt="#"></a>
                                                <div class="product-badge">
                                                    <ul>
                                                        <li class="sale-badge">-19%</li>
                                        ...
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <a href="#"><img
                                                        src="{{ url('/') }}/user_asset/img/product/5.png"
                                                        alt="#"></a>
                                                <div class="product-badge">
                                                    <ul>
                                                        <li class="sale-badge">New</li>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <a href="#"><img
                                                        src="{{ url('/') }}/user_asset/img/product/2.png"
                                                        alt="#"></a>
                                                <div class="product-badge">
                                                    <ul>
                                                        <li class="sale-badge">-19%</li>
    ...
    <div class="ltn__call-to-action-area ltn__call-to-action-4 section-bg-1 pt-110 pb-120">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <img src="{{ url('/') }}/user_asset/img/banner/11.png" alt="#">
                </div>
                <div class="col-lg-7">
            ...
            <div class="row ltn__tab-product-slider-one-active--- slick-arrow-1">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="ltn__product-item ltn__product-item-3 text-left">
                        <div class="product-img">
                            <a href="#"><img src="{{ url('/') }}/user_asset/img/product/1.png"
                                    alt="#"></a>
                            <div class="product-badge">
                                <ul>
                                    <li class="sale-badge">New</li>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="ltn__product-item ltn__product-item-3 text-left">
                        <div class="product-img">
                            <a href="#"><img src="{{ url('/') }}/user_asset/img/product/2.png"
                                    alt="#"></a>
                            <div class="product-hover-action">
                                <ul>
                                    <li>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="ltn__product-item ltn__product-item-3 text-center">
                        <div class="product-img">
                            <a href="#"><img src="{{ url('/') }}/user_asset/img/product/3.png"
                                    alt="#"></a>
                            <div class="product-badge">
                                <ul>
                                    <li class="sale-badge">New</li>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="ltn__product-item ltn__product-item-3 text-center">
                        <div class="product-img">
                            <a href="#"><img src="{{ url('/') }}/user_asset/img/product/4.png"
                                    alt="#"></a>
                            <div class="product-badge">
                                <ul>
                                    <li class="sale-badge">New</li>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="ltn__product-item ltn__product-item-3 text-center">
                        <div class="product-img">
                            <a href="#"><img src="{{ url('/') }}/user_asset/img/product/5.png"
                                    alt="#"></a>
                            <div class="product-badge">
                                <ul>
                                    <li class="sale-badge">New</li>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="ltn__product-item ltn__product-item-3 text-center">
                        <div class="product-img">
                            <a href="#"><img src="{{ url('/') }}/user_asset/img/product/6.png"
                                    alt="#"></a>
                            <div class="product-badge">
                                <ul>
                                    <li class="sale-badge">New</li>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="ltn__product-item ltn__product-item-3 text-center">
                        <div class="product-img">
                            <a href="#"><img src="{{ url('/') }}/user_asset/img/product/7.png"
                                    alt="#"></a>
                            <div class="product-badge">
                                <ul>
                                    <li class="sale-badge">New</li>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="ltn__product-item ltn__product-item-3 text-center">
                        <div class="product-img">
                            <a href="#"><img src="{{ url('/') }}/user_asset/img/product/8.png"
                                    alt="#"></a>
                            <div class="product-badge">
                                <ul>
                                    <li class="sale-badge">New</li>
        ...
        <div class="container-fluid">
            ...
            <div class="row ltn__testimonial-slider-3-active slick-arrow-1 slick-arrow-1-inner">
                <div class="col-lg-12">
                    <div class="ltn__testimonial-item ltn__testimonial-item-4">
                        <div class="ltn__testimoni-img">
                            <img src="{{ url('/') }}/user_asset/img/testimonial/6.jpg" alt="#">
                        </div>
                ...
                <div class="col-lg-12">
                    <div class="ltn__testimonial-item ltn__testimonial-item-4">
                        <div class="ltn__testimoni-img">
                            <img src="{{ url('/') }}/user_asset/img/testimonial/7.jpg" alt="#">
                        </div>
                        <div class="ltn__testimoni-info">
                            <p>Lorem ipsum dolor sit amet, consectetur adipi sicing elit, sed do eiusmod tempor incididunt
                                ut labore et dolore magna aliqua. </p>
                ...
                <div class="col-lg-12">
                    <div class="ltn__testimonial-item ltn__testimonial-item-4">
                        <div class="ltn__testimoni-img">
                            <img src="{{ url('/') }}/user_asset/img/testimonial/1.jpg" alt="#">
                        </div>
                        <div class="ltn__testimoni-info">
                            <p>Lorem ipsum dolor sit amet, consectetur adipi sicing elit, sed do eiusmod tempor incididunt
                                ut labore et dolore magna aliqua. </p>
                ...
                <div class="col-lg-12">
                    <div class="ltn__testimonial-item ltn__testimonial-item-4">
                        <div class="ltn__testimoni-img">
                            <img src="{{ url('/') }}/user_asset/img/testimonial/2.jpg" alt="#">
                        </div>
                        <div class="ltn__testimoni-info">
                            <p>Lorem ipsum dolor sit amet, consectetur adipi sicing elit, sed do eiusmod tempor incididunt
                                ut labore et dolore magna aliqua. </p>
                ...
                <div class="col-lg-12">
                    <div class="ltn__testimonial-item ltn__testimonial-item-4">
                        <div class="ltn__testimoni-img">
                            <img src="{{ url('/') }}/user_asset/img/testimonial/5.jpg" alt="#">
                        </div>
                        <div class="ltn__testimoni-info">
                            <p>Lorem ipsum dolor sit amet, consectetur adipi sicing elit, sed do eiusmod tempor incididunt
                                ut labore et dolore magna aliqua. </p>
